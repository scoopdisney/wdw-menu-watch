// Venue table for wdw-menu-watch. Edit THIS file to add or remove venues; scan.mjs imports it.
// Format: one line per area, `<area-slug>: <venue-slug> <venue-slug> ...`. Area slugs map to display names in AREA_NAMES.
